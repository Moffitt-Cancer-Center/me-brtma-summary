...
data_frame<-read_excel("ERforBoxplot(no blanks)07102024.xlsx")
...
data_frame<-read_excel("PRforBoxplot(no blanks)07112024.xlsx")
...
data_frame<-read_excel("HER2forBarChart(no blanks)07112024.xlsx")
...
#HR/HER2
library(readxl)
data_frame<-(read_excel("HRHER2forR(no blanks) MR 09102024.xlsx"))
